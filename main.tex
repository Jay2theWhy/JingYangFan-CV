    ...
    \resumeSubheading
      ...
      {Laserfiche}{Toronto, Ontario}
        \resumeItemListStart
            ...
            \resumeItem{Enhanced the performance of two \textbf{c\#} microservices that made requests to our \textbf{PostgreSQL} database by implementing batch and asynchronous \textbf{RESTful APIs}. Our biggest clients with more than 20,000 users observed a runtime reduction of 93\% when performing large-scale operations.}
